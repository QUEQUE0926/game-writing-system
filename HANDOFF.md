...
- **dev 库真实数据（2026-09-12 晚）**：26 系列 / 27 版本 / 29 个源 / 约 3.3 万句台词。**已完成分类+切集的源 15 个**（原 6 个 + 本轮 7 个 + 星际2 复扫 + Subnautica2 源b 补分类切集）：镇邪Ⅱ、星际裂变×2、星际2、沃德灵、银翼喵侍、Apex 训练场（20集）、Good Heavens（10集）、Subnautica2 源a（35集）、Subnautica2 源b（46集，solo 模式全 author）、Yerba Buena（4集）、地狱公主（24集）、灰烬之国正式版（14集）、灰烬之国8月更新（9集）。切集总数 239 集。
