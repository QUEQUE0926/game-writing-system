...
EXPECTED_COLUMNS: dict[str, set[str]] = {
    ...
    "events": {"id", "game_version_id", "source_id", "window_line_start",
               "level", "title", "event_type", "topics", "state_before",
               "trigger", "state_after", "change_before", "change_after",
               "experience_chain", "core_observation", "interpretation",
               "boundary", "tension", "why_valuable", "possible_question",
               "external_fact_needed", "thread_signals", "value_level",
               "confidence", "model", "prompt_version", "status", "created_at"},
    "event_evidence": {"event_id", "segment_id"},
    "questions": {"id", "game_version_id", "question", "question_type",
                  "strength", "resolution", "possible_directions", "status",
                  "created_at"},
    "question_events": {"question_id", "event_id"},
    "threads": {"id", "game_version_id", "title", "primary_topic",
                "central_tension", "central_question", "central_question_id",
                "start_state", "end_state", "turning_point_event_id",
                "experience_arc", "potential_thesis", "closure_target",
                "external_fact_needed", "maturity", "confidence", "status",
                "created_at"},
    "thread_events": {"thread_id", "event_id", "role"},
    "event_relations": {"id", "game_version_id", "from_event_id",
                        "to_event_id", "relation", "same_thread", "confidence",
                        "model", "created_at"},
